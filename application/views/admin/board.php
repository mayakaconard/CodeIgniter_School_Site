            ...
            <div class="wraper container-fluid">
                ...
                <!-- <div class="container"> -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content p-0 b-0">
                                            <div class="panel panel-color panel-primary">
                                                <div class="panel-heading">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="ion ion-close"></span></button>
                                                    <h3 class="panel-title">Add Board Member </h3>
                                                </div>
                                                <div class="panel-body">
                                                     <!-- Basic example -->
                                                <div class="col-md-12">
                                                    <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Add_bom');?>">
                                                         <div class="form-group">
                     ...
                     <div class="row">
                         <div class="col-lg-6">
                          <button class="btn btn-success btn-rounded m-b-5" data-toggle="modal" data-target="#panel-modal2" ><i class="fa fa-edit"></i>Add Board Member</button>
                        </div>
                     </div>
                        <?php
                        ...
                        <div class="portlet">
                            <div class="portlet-heading bg-info">
                                <h3 class="portlet-title">
                                    Board of Management(BOM) Members
                                </h3>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo base_url();?>assets/news/<?php echo $t['pass'];?>" alt=""style="height: 60px; width: 70px;" /></td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content p-0 b-0">
                                                            <div class="panel panel-color panel-primary">
                                                                <div class="panel-heading">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="ion ion-close"></span></button>
                                                                    <h3 class="panel-title">Delete Selected Board Member</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                     <!-- Basic example -->
                                                                <div class="col-md-12">
