            ...
            <div class="wraper container-fluid">
                ...
                <!-- <div class="container"> -->
                                        ...
                                        <div class="modal-content p-0 b-0">
                                            <div class="panel panel-color panel-primary">
                                                ...
                                                <div class="panel-body">
                                                     <!-- Basic example -->
                                                <div class="col-md-12">
                                                    <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Add_teacher');?>">
                                                         <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="combination" class="form-control" id="combination" placeholder="combination">
                                                        </div>
                                                         <div class="form-group">
                     ...
                     <div class="row">
                         <div class="col-lg-6">
                          <button class="btn btn-success btn-rounded m-b-5" data-toggle="modal" data-target="#panel-modal2" ><i class="fa fa-edit"></i>Add Teacher</button>
                        </div>
                     </div>
                         <?php
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content p-0 b-0">
                                                            <div class="panel panel-color panel-primary">
                                                                <div class="panel-heading">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="ion ion-close"></span></button>
                                                                    <h3 class="panel-title">Delete Selected Teacher</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                     <!-- Basic example -->
                                                                <div class="col-md-12">
                                                                    <form role="form" method="post" enctype="multipart/data" action="<?php echo base_url('Admin/delete_teacher/'.$t['id']);?>">
