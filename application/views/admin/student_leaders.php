                                        ...
                                        <div class="modal-content p-0 b-0">
                                            <div class="panel panel-color panel-primary">
                                                ...
                                                <div class="panel-body">
                                                     <!-- Basic example -->
                                                <div class="col-md-12">
                                                   <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Add_leader');?>">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="level">Form</label>
                                                            <input type="text" name="level" class="form-control" id="level" placeholder="Form">
                                                        </div>
                                                        <div class="form-group">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $t['surname'].' '.$t['first_name'].' '.$t['middle_name'];?></td>
                                                    <td><?php echo $t['level'];?></td>
                                                    <td><?php echo $t['position'];?></td>
                                                    <td>
                                                      <div class="btn-group">
                                                       <a href="" class="btn btn-danger" data-target="#delete<?php echo $t['st_id'];?>" data-toggle="modal"><i class="glyphicon glyphicon-trash"></i></a>
                                                    </div>
                                                    </td>
                                                                                       <!-- DELETE STUDENT LEADER -->
                                               <div id="delete<?php echo $t['st_id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content p-0 b-0">
                                                            <div class="panel panel-color panel-primary">
                                                                <div class="panel-heading">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="ion ion-close"></span></button>
                                                                    <h3 class="panel-title">Delete Selected Student leader</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                     <!-- Basic example -->
                                                                <div class="col-md-12">
                                                                    <form role="form" method="post" enctype="multipart/data" action="<?php echo base_url('Admin/delete_student/'.$t['st_id']);?>">
